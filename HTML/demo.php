...
<table class="default">
 ...
 <tr>
    <td>Cliente:</td>
    <td><input type="text" name="nombre_cliente" placeholder="Nombre Cliente" maxlength="50" value="" size="25" oninput="this.value = this.value.replace(/[^a-zA-Z]/,'')" required></td>
 </tr>
 <tr>
...
<center>
<br><br>
<h1>Descripcion de servicios</h1>
