...
<table class="default">
 ...
 <tr>
    ...
    <td><input type="text" name="identificacion_fiscal_cliente" placeholder="Ingrese RTN" value="" maxlength="14" size="15" oninput="this.value = this.value.replace(/[^0-9]/,'')" required></td></td>
 </tr>
</table>
...
<table cellpadding="" border="5">
 <tr>
    <td>Descripción:</td>
    <td><input type="text" name="Descripcion" placeholder="Ingrese una descripcion para su factura" maxlength="49" size="50" oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s]/,'')" required></td>
 </tr>
 <tr><br>
    <td>Gravado:</td>
