...
// $user_query = mysqli_query($con,"select * from TBL_USUARIO where Id_Usuario = '$session_id'")or die(mysql_error());
// $user_row = mysqli_fetch_array($user_query);
// $user_username = $user_row['TBL_USUARIO'];
//    $nombre=$user_row['TBL_USUARIO'];
