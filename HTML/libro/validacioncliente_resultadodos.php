...
<title>Verificacion - Estado de Resultado</title>
            ...
            <label for="text" > Verificacion - Estado de Resultado</label>
                        <br>
            <h6><a  class="btn btn-primary"  href="validacionresultado.php ">Volver Atrás</a></h6>
<br>
            <br>
...
<br>
<br>
 <a  class="btn btn-success" target="_blank" href="../gestiones/Reporte_Estado_Resultado.php ">Generar Reporte</a>
        
           </div>
