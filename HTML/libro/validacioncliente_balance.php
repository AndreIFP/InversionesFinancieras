...
if ($fechaf < $fechai) {
	echo "<script> alert('La fecha final no debe ser menor a la inicial');window.location= 'validacionbalance.php' </script>";
}
...
?>
<form method="post" action="validacioncliente_balancedos.php" name="miformulario">
	<?php
	session_start();
