...
<title>Verificacion - Balance General</title>
            ...
            <label for="text" > Verificacion - Balance General</label>
                        <br>
            <h6><a  class="btn btn-primary"  href="validacionbalance.php ">Volver Atrás</a></h6>
<br>
            <br>
...
<br>
<br>
 <a  class="btn btn-success" target="_blank" href="../gestiones/Reporte_Balance.php ">Generar Reporte</a>
        
           </div>
