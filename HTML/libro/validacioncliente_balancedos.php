...
<section style=" background-color:rgb(255, 255, 255); padding: 15px; color:black; font-size: 20px;">
  ...
  <title>Verificacion - Balance General</title>

  <h6><a class="btn btn-primary" href="validacionbalance.php "><i class="fa fa-arrow-circle-left"></i>  Volver Atrás</a></h6>
<hr>
  <center>
    <H1><strong> Balance General </strong></H1>
  ...
  <hr>
  <div align="right">
  <a class="btn btn-success" target="_blank" href="../gestiones/Reporte_Balance.php ">Generar Reporte <i class="fa fa-arrow-circle-right"></i> </a>
     </div>
  </secction>
  </div>
  </div>
