...
if (!isset($_SESSION['rol'])) {
   ...
   if ($_SESSION['permisos'][M_REP_ESTADORESULTADO]['r']==0 or !isset($_SESSION['permisos'][M_REP_ESTADORESULTADO]['r'])) {
...
<title>Estado de Resultado</title>
            <label for="text" > Estado de Resultado </label>
...
           </div>
           <div class="col-md-4">
             <form method="post" action="validacioncliente_resultado.php" enctype="multipart/form-data" class="form-horizontal">
