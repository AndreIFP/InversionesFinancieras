  ...
  <div class="menu-bar">
      <div class="menu">
          ...
          <li class="search-box">
              ...
              <li class="" >
                  <a href="Usuarios.php" style="align-items: center;">
                      <i class='bx bx-user icon'></i>
                      <span class="text nav-text" >Registro Usuarios</span>
                  </a>
              </li>

              <li class="" >
                  <a href="Clientes.php" style="align-items: center;">
                      <i class='bx bx-user icon'></i>
...
$consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Bancos';" );
              while($row=mysqli_fetch_array($consulta)){
                  $banco = ['TOTAL_CUENTA'];
                  
  ?>
                 
                 <th><?php $banco=$row['TOTAL_CUENTA']?></th>
            ...
            if(empty($banco)){
              $banco = 0;
                ...
                ?>
              <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Caja';" );
              while($row=mysqli_fetch_array($consulta)){
                $caja = ['TOTAL_CUENTA'];
?>
               
               <th><?php $caja=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Cuentas x Cobrar';" );
              while($row=mysqli_fetch_array($consulta)){
                $cxc = ['TOTAL_CUENTA'];
?>
               
               <th><?php $cxc=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Documentos por cobrar';" );
              while($row=mysqli_fetch_array($consulta)){
                $dxc = ['TOTAL_CUENTA'];
?>
               
               <th><?php $dxc=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Pagos Anticipados';" );
              while($row=mysqli_fetch_array($consulta)){
                $pag_anti = ['TOTAL_CUENTA'];
?>
               
               <th><?php $pag_anti=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Inventario';" );
              while($row=mysqli_fetch_array($consulta)){
                $inventario = ['TOTAL_CUENTA'];
?>
               
               <th><?php $inventario=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Edificios';" );
              while($row=mysqli_fetch_array($consulta)){
                $edificio = ['TOTAL_CUENTA'];
?>
               
               <th><?php $edificio=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Mobiliario y Equipo';" );
              while($row=mysqli_fetch_array($consulta)){
                $mob = ['TOTAL_CUENTA'];
?>
               
               <th><?php $mob=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Otros Activos';" );
              while($row=mysqli_fetch_array($consulta)){
                $otros_act = ['TOTAL_CUENTA'];
?>
               
               <th><?php $otros_act=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Depreciacion Acumulada';" );
              while($row=mysqli_fetch_array($consulta)){
                $depre = ['TOTAL_CUENTA'];
?>
               
               <th><?php $depre=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Deuda a Corto Plazo';" );
              while($row=mysqli_fetch_array($consulta)){
                $deuda_corto = ['TOTAL_CUENTA'];
?>
               
               <th><?php $deuda_corto=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Provisiones a Corto Plazo';" );
              while($row=mysqli_fetch_array($consulta)){
                $provi = ['TOTAL_CUENTA'];
?>
               
               <th><?php $provi=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Proveedores';" );
              while($row=mysqli_fetch_array($consulta)){
                $provee = ['TOTAL_CUENTA'];
?>
               
               <th><?php $provee=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Cuentas por Pagar';" );
              while($row=mysqli_fetch_array($consulta)){
                $cxp = ['TOTAL_CUENTA'];
?>
               
               <th><?php $cxp=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Deuda a Largo Plazo';" );
              while($row=mysqli_fetch_array($consulta)){
                $deuda_largo = ['TOTAL_CUENTA'];
?>
               
               <th><?php $deuda_largo=$row['TOTAL_CUENTA']?></th>
 ...
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Provisiones a Largo Plazo';" );
              while($row=mysqli_fetch_array($consulta)){
                $provi_largo = ['TOTAL_CUENTA'];
?>
               
               <th><?php $provi_largo=$row['TOTAL_CUENTA']?></th>
 ...
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Capital Social';" );
              while($row=mysqli_fetch_array($consulta)){
                $capital_social = ['TOTAL_CUENTA'];
?>
               
               <th><?php $capital_social=$row['TOTAL_CUENTA']?></th>
            ...
            ?>
            <?php
 $consulta=mysqli_query($conn,"SELECT TOTAL_CUENTA FROM TBL_LIBRO_MAYOR where  ID_CLIENTE = $cliente AND fecha >='$fechai' and fecha <='$fechaf' And CUENTA = 'Utilidades Retenidas';" );
              while($row=mysqli_fetch_array($consulta)){
                $utilidades = ['TOTAL_CUENTA'];
?>
               
               <th><?php $utilidades=$row['TOTAL_CUENTA']?></th>
...
<table id="ejemplo" class="gridview">
    ...
    <tbody><tr class=""><th><label for="companyDirectorModel_Forename" >Bancos</label></th><td class=""><?php echo $banco; ?></td></tr>
    ...
    <tr class="Date"><th><label for="companyDirectorModel_BirthInformation_Date">Inventario</label></th><td class=""><?php echo $inventario; ?></td></tr>
    <tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Activo Corriente</label></th><td class=""><?php echo $total_activo_corriente; ?></td></tr>
...
<tbody><tr class=""><th><label for="companyDirectorModel_Forename">Edificio</label></th><td class=""><?php echo $edificio; ?></td></tr>
    <tr class="Surname"><th><label for="companyDirectorModel_Surname">Mobiliario y equipo</label></th><td class=""><?php echo $mob; ?></td></tr>
    <tr class="TaxCode"><th><label for="companyDirectorModel_TaxCode">Otros activos</label></th><td class=""><?php echo $otros_act; ?></td></tr>
    <tr class="Gender"><th><label for="companyDirectorModel_Gender">Depreciacion acumulada</label></th><td class=""><?php echo $depre; ?></td></tr>
<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Activo  no Corriente</label></th><td class=""><?php echo $total_activo_no_corriente; ?></td></tr>
<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Activo </label></th><td class=""><?php echo $total_activo; ?></td></tr>


</tbody></table>
<center><h2 >Pasivo</h2></center>
<table  id="ejemplo" class="gridview">
    <tr class="title_row">
        <th colspan="2">Pasivo Corriente</th>
</tr>
<tbody><tr class=""><th><label for="companyDirectorModel_Forename">Deuda a corto Plazo</label></th><td class=""><?php echo $deuda_corto; ?></td></tr>
    <tr class="Surname"><th><label for="companyDirectorModel_Surname">Provisiones a corto plazo</label></th><td class=""><?php echo $provi; ?></td></tr>
    <tr class="TaxCode"><th><label for="companyDirectorModel_TaxCode">Proveedores</label></th><td class=""><?php echo $provee; ?></td></tr>
    <tr class="TaxCode"><th><label for="companyDirectorModel_TaxCode">cuentas por pagar</label></th><td class=""><?php echo $cxp; ?></td></tr>
<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Pasivo Corriente</label></th><td class=""><?php echo $total_pasivo_corriente; ?></td></tr>
...
<tbody><tr class=""><th><label for="companyDirectorModel_Forename">Deuda a Largo Plazo</label></th><td class=""><?php echo $deuda_largo; ?></td></tr>
    <tr class="Surname"><th><label for="companyDirectorModel_Surname">Provisiones a Largo plazo</label></th><td class=""><?php echo $provi_largo; ?></td></tr>

<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Pasivo no Corriente</label></th><td class=""><?php echo $total_pasivo_no_corriente; ?></td></tr>
<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Pasivo </label></th><td class=""><?php echo $total_pasivo; ?></td></tr>

    

</tbody></table>
<center><h2 >Patrimonio</h2></center>
<table id="ejemplo" class="gridview">
    <tr class="title_row">
        <th colspan="2">Patrimonio</th>
</tr>
<tbody><tr class=""><th><label for="companyDirectorModel_Forename">Capital Social</label></th><td class=""><?php echo $capital_social; ?></td></tr>
    <tr class="Surname"><th><label for="companyDirectorModel_Surname">Utilidades Retenidas</label></th><td class=""><?php echo $utilidades; ?></td></tr>

<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Patrimonio</label></th><td class=""><?php echo $total_patrimonio; ?></td></tr>
<tr class="Province"><th><label for="companyDirectorModel_BirthInformation_Province">Total Pasivo y Patrimonio</label></th><td class=""><?php echo $total_pasivo_patrimonio; ?></td></tr>
    
</tbody></table>
<br>
<?php
  include('../conexion.php');
  $query_insert = mysqli_query($conn,"INSERT INTO TBL_BALANCE(Id_cliente,Total_activo,Total_Pasivo,Total_Patrimonio,Total_Pasivo_Patrimonio)
                        VALUES('$cliente','$total_activo','$total_pasivo','$total_patrimonio','$total_pasivo_patrimonio')");
?>
<a class="reportes"><a class="btn btn-warning" href="../gestiones/Reporte_Balance.php" >Reporte</a> </div>
