...
.dataTables_wrapper .dataTables_paginate .paginate_button:hover {
  ...
  <a name="" id="" class="button btn-info" href="balance.php" role="button">ATRAS</a>
...
?>
    ...
    <br>
    <center><label for="Name"><?php echo $nombre ?></label></center>
    <br>
    <center>
    <label for="Name"><?php echo $dia ?> de <?php echo $mes ?> del <?php echo $años ?> </label>
  </center>
