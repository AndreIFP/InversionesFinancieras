...
<body class="nav-md">
  ...
  <a class="btn btn-primary" href="validacionestado.php"> <i class="fa fa-arrow-circle-left"></i> Volver Atrás</a>
    ...
    <div class="box-body ">
      <!-- BOTONES -->
      <div align="left">
      <?php if ($_SESSION['permisos'][M_ESTADORESULTADO] and $_SESSION['permisos'][M_ESTADORESULTADO]['w'] == 1) {
      ...
      <?php } ?>
      <a class="btn btn-success btn-print" href="../gestiones/Reporte_Resultado.php" onclick="window.open(this.href,this.target, 'width=1000,height=700');return false;"><i aria-hidden="true" class ="glyphicon glyphicon-print"></i> Imprimir</a>
      <a class="btn btn-secondary btn-print" href="../gestiones/Reporte_Estado_Resultado.php" onclick="window.open(this.href,this.target, 'width=1000,height=700');return false;"><i class="fa fa-book" aria-hidden="true" class ="glyphicon glyphicon-print"></i> Generar Estado De Resultado</a>
      </div>
            ...
            <tr>
              ...
              <td class="btn-print">
                <center>
                  ...
                  ?>
                  <?php if ($_SESSION['permisos'][M_ESTADORESULTADO] and $_SESSION['permisos'][M_ESTADORESULTADO]['d'] == 1) {
