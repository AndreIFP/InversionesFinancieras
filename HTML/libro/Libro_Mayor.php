...
<section style=" background-color:rgb(255, 255, 255);
  ...
  <div class="reportes">
    ...
    <a class="btn btn-success btn-print" href="../gestiones/Reporte_libro_mayor.php" onclick="window.open(this.href,this.target, 'width=1000,height=700');return false;"><i aria-hidden="true" class ="glyphicon glyphicon-print"></i> Imprimir</a>
