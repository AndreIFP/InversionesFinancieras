...
if (!isset($_SESSION['rol'])) {
   ...
   if ($_SESSION['permisos'][M_ESTADORESULTADO]['r']==0 or !isset($_SESSION['permisos'][M_ESTADORESULTADO]['r'])) {
...
           </div>
           <div class="col-md-4">
             <form method="post" action="validacioncliente_estado.php" enctype="multipart/form-data" class="form-horizontal">
