...
<body id="body">
  <section style=" background-color:rgb(255, 255, 255);
    ...
    <div class="row section">
      ...
      <div class="col-12">
        <h1 align="center">FACTURA POR HONORARIOS</h1>
      </div>
      <!--.col-->
    ...
    <div align="right">
      ...
      <label for="config_tax_rate" class="taxrelated">Tasa:
        <input type="text" oninput="this.value = this.value.replace(/[^0-9_.]/,'')" id="config_tax_rate" value="1" />%
      </label>
