...
$direccion = $_SERVER['QUERY_STRING'];

for($i=0; $i<2; $i++)
{
// pasando el valor option=com_seyret que son los primero 17 caracteres de $_SERVER['QUERY_STRING'] o $direccion
$palabra="";
$palabra= $palabra .$direccion;
$id = substr("$palabra",3 );  // devuelve "cde"
//echo "<script> alert('R: ".$id."' );window.location= 'login.php' </script>"; 
...
<tr>
 <td>Articulo:</td>
 <td>
 <label><label for="CLASIFICACION">
    <?php
    $sqlc = "SELECT proname FROM product where id='$id'";
