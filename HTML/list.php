...
<nav id="menu" class="sidebar close">
 ...
 <br>
              ...
              <li class="" style="height: 50px;">
                  <a href="list.php" style="align-items: center;">
              ...
              <li class="" class="fa fa-caret-down"   >
                ...
                <a href="index.php" style="align-items: center; height: 50px;  "  >
                  ...
                  <a href="gestiones/Gestion_Compras.php" style="align-items: center; ">
                    <span class="text nav-text" >Gestion Compras</span>
                </a>
...
font-size: 20px; ">
  ...
  <div class="container mt-12">
    ...
    <div class="header">
        ...
        <h3>INVENTARIO</h1>
        <h4>Has accedido como <?php echo $str = strtoupper($username) ?></h2>
    ...
    <div class="table-product">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="delete"><a name="id" id="" class="bdelete" href="compras/salida.php?id=<?php echo $row['id'] ?>" role="button">
                                RETIRAR
                            </a></td>
                    </tr>
                <?php
        ...
        <a name="" id="" class="Addlist" style="float:left" href="Compras/kardex.php" role="button">REVISAR KARDEX</a>
        <br>
    </div>
    <?php
    mysqli_close($conn);
