...
<html lang="en">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.png">
     <title>Gastos |  Sistemas Web </title>
                        ...
                        <li class="">
                         ...
                         <li class="submenu">
                            ...
                            <ul class="list-unstyled" style="">
                                <li class="active"><a href="expences.php">Gastos</a></li>
...
</form> <form class="form-horizontal form-label-left input_mask" method="post" id="upd_expence" name="upd_expence">  
