...
<section style=" background-color:rgb(255, 255, 255); padding: 15px; color:black; font-size: 16px; ">
  ...
  <a href="factura/Facturacion_H1.php" type="submit" class="btn btn-success btn-lg">FACTURA POR SERVICIOS</a><br><br>
  <a href="factura/Facturacion_H.php" type="submit" class="btn btn-success btn-lg">FACTURA POR HONORARIOS</a>
