...
header("Content-Disposition: attachment; filename= Reporte Balanza De Comprobación.xls");
...
$sql = "select tcc.CODIGO_CUENTA,tcc.CUENTA,tb.Mhaber,tb.Mdebe,tb.Sdebe,tb.SAcreedor  from tbl_balanza tb
...
<label><center>Reporte Balanza Comprobación</center></label>
