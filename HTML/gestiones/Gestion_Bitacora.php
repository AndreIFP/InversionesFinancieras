    ...
    <div class="container-fluid">
        ...
        <div class="box-body table-responsive">
            <div class="reportes">
                ...
                <a class="btn btn-warning" href="Reporte_Bitacora.php" onclick="window.open(this.href,this.target, 'width=1000,height=700');return false;"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Reporte pdf</a>
