...
$sql = "SELECT * FROM FACTURA where CLIENTE LIKE '%$facturax%' OR NFACTURA LIKE '%$facturax%'";
...
while ($fila = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(20, 5, utf8_decode($fila['NFACTURA']), 1, 0, "C",0);
    $pdf->Cell(35, 5, utf8_decode($fila['CLIENTE']), 1, 0, "C",0);
    $pdf->Cell(100, 5, utf8_decode($fila['DESCRIPCION']), 1, 0, "C",0);
    $pdf->Cell(22, 5, utf8_decode($fila['TOTAL']), 1, 1, "C",0);
}
