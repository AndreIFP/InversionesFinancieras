...
function Header()
{
  require ('../conexion.php');
    ...
    $this->Cell(78);
    $this->Cell(10,60, utf8_decode('Reporte Libro Mayor' ),0,7);
    $this->Ln(-53);
...
$sql= "SELECT * FROM tbl_libro_mayor2 where  id_cliente = $cliente AND fecha >='$fechai' and fecha <='$fechaf' ";
...
$pdf->Ln(5);
$pdf->setX(90);
$pdf->Write(5, utf8_decode('Mayorización'),0,7);
$pdf->Ln(7);
...
$pdf->Cell(95,5, utf8_decode('Cuentas'),1,0,'C',1);
$pdf->Cell(30,5, utf8_decode('Total Cuenta'),1,1,'C',1);
