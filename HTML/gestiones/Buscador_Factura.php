           ...
           <title>Gestión Facturas</title>
                  <div class="col-md-12">
                    ...
                    ?>
                     ...
                     <h6><a  class="btn btn-primary"  href="Gestion_Factura.php ">Volver Atrás</a></h6>
                  ...
                  <div class="reportes">
                  <a class="btn btn-warning" href="Reporte_Factura_Buscador.php?variable=<?php echo $busqueda;?>" >Reporte</a>
                  </div>
           </div>
    </section>
    </body>
