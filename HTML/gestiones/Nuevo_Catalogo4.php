		...
		$(document).ready(function() {
			$("#cbx_estado").change(function() {
				...
				$("#cbx_estado option:selected").each(function() {
					id_estado = $(this).val();
					$.post("includes4/getMunicipio.php", {
						id_estado: id_estado
					}, function(data) {
							...
							<td style="width:50%;">
								...
								<div class="input-group">
									...
									<div class="input-group">
										...
										<span class="input-group-addon"><i class="fa fa-check"></i></span>
										<select class=" elegir elegirl form-control js-example-basic-single" name="cbx_calle" id="cbx_calle"></select>
									</div>
								</div>
							...
							<td style="width:50%;">
								...
								<div class="input-group">
									...
									<div class="input-group">
										...
										<!-- <span  class="input-group-addon"><i class="fa fa-check"></i></span> -->
										<select hidden class=" elegir elegirl form-control" name="cbx_casa" id="cbx_casa"></select>
									</div>
								</div>
