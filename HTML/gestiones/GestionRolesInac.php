...
font-size: 12px; ">
    ...
    <a class="btn btn-warning" href="Reporte_Roles_Inacti.php" target="_blank" onclick="window.open(this.href,this.target, 'width=1000,height=600');return false;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Reporte pdf</a>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <th><center><a href="Actualizar_Roles.php?Id=<?php echo $row['Id_Rol'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-eraser" aria-hidden="true"></i></a></center></th>
                        <p>
                    </tr>
            <?php
                }
