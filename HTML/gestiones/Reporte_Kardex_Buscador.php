...
function Header()
{
    ...
    $this->Cell(105);
    $this->Cell(8,0, utf8_decode('Reporte De Kardex' ),0,7);
    $this->Ln(3);
...
$sql = "SELECT * FROM TBL_KARDEX where proname";
...
$pdf->Cell(30,5, utf8_decode('Detalle'),1,0,'C',1);
$pdf->Cell(50,5, utf8_decode('Producto'),1,0,'C',1);
$pdf->Cell(45,5, utf8_decode('Cantidad de Inventario Entrante'),1,0,'C',1);
$pdf->Cell(35,5, utf8_decode('Total Inventario Entrante'),1,0,'C',1);
$pdf->Cell(45,5, utf8_decode('Cantidad de Inventario Saliente'),1,0,'C',1);
$pdf->Cell(35,5, utf8_decode('Total Inventario Saliente'),1,1,'C',1);
...
while ($fila = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(35, 5, utf8_decode($fila['total_cante']), 1, 0, "R",0);
    $pdf->Cell(45, 5, utf8_decode($fila['cant_salida']), 1, 0, "C",0);
    $pdf->Cell(35, 5, utf8_decode($fila['total_cants']), 1, 1, "R",0);
}
