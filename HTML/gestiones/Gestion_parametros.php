    ...
    <div class="box-body table-responsive">
        <div class="reportes">
            ...
            <a class="btn btn-warning" href="Reporte_Parametro.php" onclick="window.open(this.href,this.target, 'width=1000,height=700');return false;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Reporte</a>
                <a class="btn btn-success" href="reporte_excel_parametros.php"> Reporte excel</a>
        </div>
        <?php
        $mostrar_datos = 0;
        ?>
        ...
        <table class="table">
            <thead class="table-primary">
                <tr>
                    ...
                    <th>
                        <center>Nombre Parametro </center>
                    </th>
                    <th>
                        <center>Valor </center>
                    </th>
            ...
            <tbody>
                ...
                $sql = mysqli_query($conn, "select * FROM tbl_parametros ORDER BY Id_Parametro DESC LIMIT $desde,$por_pagina ");
                mysqli_close($conn);
                ...
                ?>
                        <tr>
                            <th>
                                <center><?php echo $row['Id_Parametro'] ?></center>
                            </th>
                            <th>
                                <center><?php echo $row['Parametro'] ?></center>
                            </th>
                            <th>
