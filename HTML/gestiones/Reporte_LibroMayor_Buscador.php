...
$sql = "SELECT * FROM TBL_LIBRO_MAYOR where ID_LIBRO_MAYOR LIKE '%$libro%' OR ID_CLIENTE LIKE '%$libro%'";
...
while ($fila = $resultado->fetch_assoc()) {
    $pdf->setX(51);
    $pdf->Cell(20, 5, utf8_decode($fila['ID_LIBRO_MAYOR']), 1, 0, "L",0);
    $pdf->Cell(25, 5, utf8_decode($fila['ID_CLIENTE']), 1, 0, "L",0);
    $pdf->Cell(25, 5, utf8_decode($fila['TEMPORADA']), 1, 0, "L",0);
    $pdf->Cell(90, 5, utf8_decode($fila['CUENTA']), 1, 0, "L",0);
    $pdf->Cell(25, 5, utf8_decode($fila['TOTAL_CUENTA']), 1, 1, "R",0);
