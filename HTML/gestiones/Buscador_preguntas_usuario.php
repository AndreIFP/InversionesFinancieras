  ...
  <title>Gestión Preguntas Usuario</title>
           <div class="container mt-12">
                  <div class="col-md-12">
                    ...
                    ?>
                     <h1>Gestión Preguntas Usuario</h1> 
                     <a  class="btn btn-primary"  href="Gestion_PreguntasUsuarios.php ">Volver Atrás</a>
			  <a class="btn btn-warning" href="Reporte_Preg_Usu_Buscador.php?variable=<?php echo $busqueda;?>" onclick="window.open(this.href,this.target, 'width=1000,height=600');return false;" >Reporte</a>
                            ...
                            <tbody>
                                    ...
                                    $total_paginas = ceil($total_registro / $por_pagina);
                                        $sql = mysqli_query($conn,"SELECT * from TBL_PREGUNTAS_X_USUARIO WHERE ( Id_Preguntas LIKE '%$busqueda%' OR
                                                                                Id_Usuario LIKE '%$busqueda%') LIMIT $desde,$por_pagina ");
                                        mysqli_close($conn);
                                        ...
                                        ?>
                                             <tr>
                                                ...
                                                <th><a href="Actualizar_PreguntasUsu.php?Id=<?php echo $row['Id_Preguntas'] ?>"class="btn btn-primary" >Editar</a></th><p>
                                                <th><a href="Delete_PreguntasUsu.php?Id=<?php echo $row['Id_Preguntas'] ?>"class="btn btn-danger">Eliminar</a></th><p>
                                             </tr>
                                        <?php
                                               }
                                            }else{
