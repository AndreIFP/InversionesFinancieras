...
Programa:          Gestion_CatalogoCuenta_Inactivas
Fecha:             16-jul-2022
            ...
            <div class="box-body table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        //Paginador
                        $sql_registe = mysqli_query($conn, "SELECT COUNT(*) as total_registro FROM tbl_catalago_cuentas WHERE Estado_Cuenta = 'INACTIVO' ");
                        ...
                        $sql = mysqli_query($conn, "SELECT * FROM tbl_catalago_cuentas WHERE Estado_Cuenta = 'INACTIVO' LIMIT $desde,$por_pagina ");
                        mysqli_close($conn);
                        ...
                        ?>
                                <tr>
                                    <th>
                                        <center><?php echo $row['CODIGO_CUENTA'] ?></center></th>
                                    <th>
