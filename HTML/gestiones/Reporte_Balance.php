...
$pdf->Ln(5);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Bancos"), 1, 0, "L",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Caja"), 1, 0, "L",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Cuentas x Cobrar"), 1, 0, "L",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Documentos por cobrar"), 1, 0, "L",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Pagos Anticipados"), 1, 0, "L",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Inventario"), 1, 0, "L",0);
...
$pdf->Ln(0);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Edificios"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode("$edificio"), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Mobiliario y Equipo"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($mob), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Otros Activos"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($otros_act), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Depreciacion Acumulada"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($depre), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
$pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Total Total Activo No Corriente"), 1, 0, "L",1);
$pdf->Cell(30, 5, utf8_decode(""), 1, 0, "C",0);
...
$pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Total Utilidad"), 1, 0, "L",1);
$pdf->Cell(30, 5, utf8_decode(""), 1, 0, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Deuda a Corto Plazo"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($deuda_corto), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Provisiones a Corto Plazo"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($provi), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Proveedores"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($provee), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Cuentas por Pagar"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($cxp), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Deuda a Largo Plazo"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($deuda_largo), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Provisiones a Largo Plazo"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($provi_largo), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Capital Social"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($capital_social), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
...
while ($fila = $resultado->fetch_assoc()) {
  ...
  $pdf->SetFont('Arial','',14);
$pdf->setX(15);
$pdf->Cell(95, 5, utf8_decode("Utilidades Retenidas"), 1, 0, "L",0);
$pdf->Cell(30, 5, utf8_decode($provi_largo), 1, 0, "C",0);
$pdf->Cell(30, 5, utf8_decode(""), 1, 1, "C",0);
