...
function Header()
{
    ...
    $this->Cell(75);
    $this->Cell(8,0, utf8_decode('Reporte De Preguntas' ),0,7);
    $this->Ln(5);
...
$preguntas=$_GET['variable'];
// Creación del objeto de la clase heredada
$sql = "SELECT * FROM TBL_PREGUNTAS where Preguntas LIKE '%$preguntas%'";
...
while ($fila = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(100, 5, utf8_decode($fila['Preguntas']), 1, 1, "C",0);
