...
Programa:          Gestion_Usuarios_Inactivos
Fecha:             16-jul-2022
Programador:       Fanny
descripcion:       libro
        ...
        <div class="box-body table-responsive">
            <div class="reportes">
                ...
                <a class="btn btn-warning" href="Reporte_Usuario_Inac.php" onclick="window.open(this.href,this.target, 'width=1000,height=700');return false;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Reporte</a>
                 <a class="btn btn-success" href="reporte_excel_usuarios_inac.php"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Reporte excel</a>
            </div>
            <?php
            $mostrar_datos = 0;
            ?>
                ...
                <tbody>
                    ...
                    if ($result > 0) {
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            $_SESSION['Id_Mauri']         =    $row ['Id_Usuario'];;
                            $Usuario                      = $row ['Usuario'];
                    ...
                    ?>
                            <tr>
                                ...
                                <th><center> <a href="Gestion_Usuarios2_Inactivos.php?Id_Usuario2=<?php echo $Id_Usuario?>" class="btn btn-success btn-xs"> <i class="fa fa-eye" aria-hidden="true"></i> </a> </center> </th>
